...
ggplot(data = r_df) +
  ...
  coord_sf(xlim = c(-80, -10), ylim = c(5, 50)) +
  #coord_quickmap() +
...
ggplot(data = makor_df) +
  ...
  coord_sf(xlim = c(-80, -30), ylim = c(10, 45)) +
...
color_dendro <- color_branches(color_dendro, clusters = color.leaf.stmp$cluster, col = c("#FDFECCFF", "#78CEA3FF", "#488E9EFF", "#404C8BFF", "#281A2CFF")) # general patterns
plot(color_dendro)
```
...
Step 1: recreate daily TAD summaries from series data (default summaries ommit >200 days)
```{r series to tad}
# step 1: calculate the percentage of time in each depth bin for each day for each individual
# blues
...
ggplot(data = cluster_series, aes(x = Local_Time, y = depth) ) +
  ...
  scale_y_reverse(limits = c(1500, 0), breaks = c(0, 500, 1000, 1500), labels = c("0", "500", "1000", "1500")) +
